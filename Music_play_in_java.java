...
public class Music_play_in_java {
    static String start;

    public static void main(String[] args) {
        new Music_play_in_java();
    }

    public Music_play_in_java() {

        try {
            File file = new File("C:\\\\\\\\Users\\\\\\\\HP\\\\\\\\Downloads\\\\\\\\enchanted java.wav");
            ...
            System.out.print("Press 1 to relapse ");
            start = scan.next();
            clip.start();
            Clear();
            call.FirstLine();
